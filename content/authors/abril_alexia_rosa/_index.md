...
authors = ["abril_alexia_rosa"]

# Author name (this is required for people without content)
perfil_de_prueba = [""]

# Role/position
role = "Volunteer - Workshops Committee -  Networking Committee - Web Committee"
...
bio = "Mi nombre es Alexia, tengo 24 años, soy Técnica Química y Extraccionista y actualmente estoy estudiando una Licenciatura en Ciencias de Datos. Hablo tres idiomas, mi español natal, inglés avanzado y alemán básico.  Tengo intenciones de combinar mis estudios en Datos y en Tecnología con mis conocimientos previos en el área de Química y Salud. Mientras tanto, es importante para mí tener la oportunidad de formar parte de voluntariados como este, tanto para seguir aprendiendo como para acompañar y acercar a otros a este área poco conocida para muchas, tal como me ayudaron a mí a acercarme a esta área otras personas anteriormente."
...
[[education.courses]]
  course = "Técnica Química / Extraccionista"
  institution = ""

[[education.courses]]
  course = " Lic. en Ciencias de Datos "
  institution = ""
# year = ""
...
[[social]]
  icon = "envelope"
  icon_pack = "fas"
  link = "mailto:alexiaabrilrosa@gmail.com"
